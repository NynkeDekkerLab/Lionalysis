...
WT_AVG_Cyto = Cyto_WT_DnaN_Avg(:,2);
WT_lo_Cyto = Cyto_WT_DnaN_LOW(:,2); 
WT_hi_Cyto = Cyto_WT_DnaN_HIGH(:,2);
...
hold on;
ciplot(WT_lo_Cyto,WT_hi_Cyto,X_WT,[1 153/255 153/255]);   
%ciplot(WT_lo_Cyto,WT_hi_Cyto,X_WT,[152/255 251/255 152/255]);
% 152-251-152
%  	%50-205-50
...
%plot(X_WT,WT_AVG_Cyto,'-g','LineWidth',4); hold on;  
 ...
 set(gca,'TickLength',[0.02 0.02]);
   ...
   xlabel('Normalized time (-)', 'fontsize', 26, 'fontweight', 'bold')
    ...
    hleg = legend('Foci content','Cytoplasmic content');
...
print(h, '-dpdf', '-r600','WT_Foci_and_GammaMinus_Foci')
