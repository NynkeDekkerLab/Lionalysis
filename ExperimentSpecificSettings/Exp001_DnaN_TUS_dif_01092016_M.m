...
%fprintf('Using Exp001_DnaN_TUS_dif_01092016_M, the only function Mark edited?\nUser is [%s].\n', user);
...
%         initval.FLdatapath='Fluorescence\RFP\';
    ...
    case 'Josko'
        fprintf('Selected Josko his test data.\n');
        initval.basepath='C:\Users\jsdeboer\Downloads\Workshop\Presentation Data\KymoCode test data\';
        initval.BFdatapath='Brightfield\';
        initval.FiguresFolder='Figures\';
        initval.FLpath='Fluorescence\'; 
        initval.OSslash='\';
        initval.maxfile=150; %Normally, it is 421. However, I am testing with 5.
        initval.startzoom=5; %Starting zoom for RepliCluster. Needs to be lower than the image number. If less than two, A060 likely throws an error. Roy suggests about 5.
end
%initval.maxfile=421;
